...
template <typename DType, typename IdType>
hipError_t AppendPagedKVCacheDecode(
  paged_kv_t<DType, IdType> paged_kv,
  DType* key,
  DType* value,
  half2* key_param,
  ...
  SWITCH_HEAD_DIM(head_dim, HEAD_DIM, {
    constexpr size_t vec_size = ::max(static_cast<size_t>(16 / quant::size_of_type<DType>()), HEAD_DIM / 32);
...
template <typename DType, typename IdType>
hipError_t AppendPagedKVCachePrefill(
  paged_kv_t<DType, IdType> paged_kv,
  DType* key,
  DType* value,
  half2* key_param,
