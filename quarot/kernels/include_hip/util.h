...
// template <>
// __device__ inline int type2int_rn<__hip_bfloat16>(__hip_bfloat16 input) {
...
template <>
__device__ inline float type2float<__hip_bfloat16>(__hip_bfloat16 input) {
...
template <>
__device__ inline __hip_bfloat16 float2type<__hip_bfloat16>(float input) {
...
template <>
struct DtypeDtype2Dispatcher<__hip_bfloat16> {
  using value = __hip_bfloat162;
};
...
// __device__ inline __hip_bfloat162 type2type2(__hip_bfloat16 input,
...
//
// template <>
//__hip_bfloat16 div(__hip_bfloat16 a, __hip_bfloat16 b) {
//   return __hdiv(a, b);
// }
