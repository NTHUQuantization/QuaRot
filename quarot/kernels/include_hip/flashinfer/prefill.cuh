...
hipError_t SinglePrefillWithKVCache(DTypeIn *q, DTypeIn *k, DTypeIn *v, DTypeOut *o, float *tmp,
      ...
      {SWITCH_ROTARY_MODE(
          rotary_mode, ROTARY_MODE, {SWITCH_LAYOUT(layout, LAYOUT, {
            ...
            void *args[] = {(void *)&q,
                            ...
                            (void *)&rope_inv_scale,
                            (void *)&rope_inv_theta};
            FLASHINFER_CUDA_CALL(hipFuncSetAttribute(reinterpret_cast<const void*>(
