...
__global__ void BatchDecodeWithPagedKVCacheKernel(
  ...
  if (num_q_heads % num_kv_heads != 0 || q_head_idx >= num_q_heads ||
      kv_head_idx >= num_kv_heads) return;
...
hipError_t BatchDecodeWithPagedKVCache(
  ...
  SWITCH_HEAD_DIM(
      paged_kv.head_dim, HEAD_DIM, {SWITCH_ROTARY_MODE(rotary_mode, ROTARY_MODE, {
        ...
        size_t num_q_heads = paged_kv.num_heads;
        void *args[] = {(void *)&q, (void *)&paged_kv, (void *)&o,
                        (void *)&num_q_heads, (void *)&sm_scale,
                        (void *)&rope_inv_scale, (void *)&rope_inv_theta};
        FLASHINFER_CUDA_CALL(hipLaunchKernel((void *)kernel, nblks, nthrs, args, 0, stream));
      })});
